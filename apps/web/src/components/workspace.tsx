...
export function Workspace({ children, name, role }: { children: ReactNode; name: string; role?: Role }) {
  ...
  return <div className="min-h-svh bg-muted/20">
    <header className="border-b bg-background px-6 py-3"><div className="mx-auto flex max-w-screen-2xl flex-wrap items-center gap-4">
      ...
      {role === "admin" && <Link to="/admin/audit" className="text-sm" activeProps={{ className: "font-semibold text-primary" }}>Audit</Link>}
      <PeopleSearch />
